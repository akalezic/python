# Python
This repository consists of personal projects, as well as work done during the Code In Place course held by Stanford University in Spring 2020. The course corresponds to the first half of their CS106A course and teaches programming in Python. The course took place over the course of five weeks and progressed from learning basic commands to progams focusing on data analysis through the use of lists, image editing programs, and simple game design. I have divided the projects done in Code In Place and my personal projects after the course into separate sub-folders.
...
**Data_Visualization**
The Data Visualization sub-folder contains personal projects focusing on presenting data. Currently this folder contains an interactive graph of US greenhouse gas emissions as a result of electricity generation created using the pandas and plotly express libraries.
