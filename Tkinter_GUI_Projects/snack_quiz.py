...
File: snack_quiz.py
-------------------
This program acts as a quiz that helps the user figure out what snack they would like. It uses
the Tkinter library to present questions and buttons that correspond to various different snack
types until narrowing it down to one final snack.
"""
